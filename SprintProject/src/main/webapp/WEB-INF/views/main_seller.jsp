...
<div class="seller-container">
 <!-- 1. 네비게이션 -->
  ...
  <div class="seller-main">
		<jsp:include page="seller/s_dashBoard.jsp" flush="true"></jsp:include> 	 	
  </div> <!-- end seller-main  -->
</div><!-- end container  -->
...
//0. 현재 페이지의 글자색깔 바꾸기 1.dashboard 2.상품코드 3.재고관리 4.리뷰관리 5.Q&A 6.반품정보 7.배송관리 
...
(function activePageLink(){
	...
	// 이부분을 바꾸면 되겠다. 1.dashboard 2.상품코드 3.재고관리 4.리뷰관리 5.Q&A 6.반품정보 7.배송관리 
	list_a[1].classList.add('activePage');
})();
