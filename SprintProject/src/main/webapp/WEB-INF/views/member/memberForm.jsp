...
<!-- 판매자모드 소비자 모드 이벤트 버튼 absolute를 줬다 부모는 body -->
<button class="toMember" id="toMember">To.소비자</button>
<button class="toSeller" id="toSeller">To.판매자</button>
...
<div class="container">
	...
	<div class="login-container">
		<!-- 아쉽게도 h1이 css가 안먹힌다 이유를 모르겠다. 그래서 무식하게 inline올 css사용했다. -->
		<h1 class="title" style="color: #333;font-size: 3rem;">SIGN UP</h1>

		<!-- 요기가 step 회원가입  부분, mypage랑 다른점은 이부분이 다르다.  -->
		<jsp:include page="subFile/stepSignUpForm.jsp" flush="true"></jsp:include>
...
<script src="resources/js/memberPage/memberForm.js"></script>
